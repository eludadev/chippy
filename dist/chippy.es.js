...
var ChipInput_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => ".warning[data-v-217698f0]{outline-color:#ef4444;outline-style:solid;outline-width:2px}\n")();
const _hoisted_1 = {
  key: 0,
  for: "chips-input",
  ...
  setup(__props, { expose, emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("form", {
        class: normalizeClass(["bg-stone-800 px-2 py-2 rounded overflow-hidden transition-[outline] duration-200 ease-in-out", { "warning": unref(isWarning) }]),
